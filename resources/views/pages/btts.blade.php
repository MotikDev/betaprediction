...
<div style="text-align: center">
        ...
        <form action="{{ action('PagesController@btts') }}" method="POST" role="form">
...
<h3 class="text-center text-primary">Both Team to Score Prediction(s) for today</h3>
        <table class="table">
          <thead>
              <tr >
                  <th>Match Time</th>
                            ...
                            function {{ $reply }}()
                            {
                                if((count%2) == 1)
                                {
                                    ...
                                    return document.getElementById("{{ $reply }}").innerHTML = 
                                                ...
                                                +'<input type="hidden" name="_token" value="{{ csrf_token() }}">'
                                                +'<input type="hidden" name="pageName" value="btts">'
